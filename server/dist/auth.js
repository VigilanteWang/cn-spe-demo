...
exports.createGraphClient = exports.getGraphToken = exports.authorizeContainerManageRequest = void 0;
...
const graphHost = new URL(config_1.serverConfig.graphBaseUrl).hostname;
/**
...
const identityEndpoints = identityEndpointsByCloud[config_1.serverConfig.cloudEnv];
/**
...
const jwksClients = {
    ...
    "2.0": (0, jwks_rsa_1.default)({
        ...
        jwksUri: `${identityEndpoints.discoveryHost}/${config_1.serverConfig.tenantId}/discovery/v2.0/keys`,
        cache: true,
...
const confidentialClient = new msal_node_1.ConfidentialClientApplication(msalConfig);
/**
...
const getExpectedIssuer = (tokenVersion) => {
    if (tokenVersion === "2.0") {
        ...
        return `${identityEndpoints.v2IssuerHost}/${config_1.serverConfig.tenantId}/v2.0`;
    }
    // 默认为 v1.0，issuer 以斜杠结尾，不包含版本号
    return `${identityEndpoints.v1IssuerHost}/${config_1.serverConfig.tenantId}/`;
};
/**
    ...
    try {
        ...
        if (!hasRequiredScope(claims)) {
            return {
                ...
                status: 403,
                body: {
                    message: `Access token is missing required scope ${scopes_1.SPEMBEDDED_CONTAINER_MANAGE}.`,
                },
            };
        }
