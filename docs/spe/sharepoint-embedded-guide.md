...
通过 Container Type Registration API 注册后，生成 Container Type Registration，决定了 App 其下所有 Container 能做什么操作。常用权限如下：
| 权限 | 说明 |
| ------------------------------ | -------------------- |
