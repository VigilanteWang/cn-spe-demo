...
export const CLIENT_ENTRA_APP_AUTHORITY =
  "https://login.microsoftonline.com/9517aa17-4352-4384-a035-49eb9d1bc46b";

export const API_SERVER_URL = "http://localhost:3001"; //'https://fantastic-space-chainsaw-x5qqrpvrvjp2vgvp-3001.app.github.dev' //;
